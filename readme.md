...
R1.fastq.gz  
            \
             ---->   [HiCExplorer](https://hicexplorer.readthedocs.io/en/latest/)   ----> output.h5 ----> h5.to.hic.sh (see above)
            /
R2.fastq.gz 
...
R1.fastq.gz  
            \
             ----> [juicer pipeline](https://github.com/aidenlab/juicer/wiki) ----> merged_nodups.txt ----> juicer tools (see below)
            /
R2.fastq.gz  
