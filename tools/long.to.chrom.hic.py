...
required.add_argument("-g", type=str, required=True, help="Genome ID (for example: hg18, hg19, hg38, mm9, or mm10) or path to chrom.size bed file (chrom\tlength) used in analysis.", metavar='Genome ID')
...
optional.add_argument("-Q", type=int, required=False, help="Mapping quality score for filtering Hi-C contacts (default: %s)."%quality, default=quality, metavar='%s'%quality)
